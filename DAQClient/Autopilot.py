...
class Autopilot:
    ...
    def autopilot_as_dict(self):
        ...
        return {
            "user": self.autopilot_user,
            "run_type": self.autopilot_run_type,
            "run_notes": self.autopilot_run_notes,
            "autorestart": self.autopilot_autorestart,
            "run_length": self.autopilot_run_length,
        }
    ...
    def autopilot___str__(self):
        ...
        if self.autopilot_autorestart:
            return "User: %s\nRun Type: %s\nRun Length: %s\nNotes:\n%s\n" % (
                self.autopilot_user,
                self.autopilot_run_type,
                self.autopilot_run_length,
                self.autopilot_run_notes,
            )
        else:
            return "User: %s\nRun Type: %s\nNotes:\n%s\n" % (
                self.autopilot_user,
