...
A high-performance Data Acquisition (DAQ) system designed to receive and log particle accelerator spill data from multiple FPGA boards. The project includes a robust server and a multi-threaded "Fake FPGA" simulator for testing high-bandwidth network ingestion.
